...
$baseurl = "http://api.proximusmobility.com:8080/ProximusTomorrow-war/api/webinteraction/";
...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    <html>
        <form method="POST" ACTION="<?php echo $_SERVER['PHP_SELF']; ?>">
            MSISDN: <input name="msisdn" value="13405147898" size="80"><br/>
            Email Address: <input name="email" value="rwilliams@proximusmobility.com" size="80"><br/>
            ...
            Categories: <input name="category" value="grocery,electronics" size="80"/><br/>
            Locales: <input name="locale" value="es,en" size="80"/><br/>
