 ...
 */
@Entity
@Table(name = "view_active_users")
public class ViewActiveUsers {
    ...
    public boolean equals(Object obj) {
        ...
        final ViewActiveUsers other = (ViewActiveUsers) obj;
    ...
    public int hashCode() {
        ...
        hash = 59 * hash + (this.eventDate != null ? this.eventDate.hashCode() : 0);
        hash = 59 * hash + (this.activeUsers != null ? this.activeUsers.hashCode() : 0);
