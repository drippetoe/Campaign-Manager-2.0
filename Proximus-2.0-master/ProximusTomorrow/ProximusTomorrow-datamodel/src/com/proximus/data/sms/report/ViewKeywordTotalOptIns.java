 ...
 */
@Entity
@Table(name = "view_keyword_total_opt_ins")
public class ViewKeywordTotalOptIns implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        final ViewKeywordTotalOptIns other = (ViewKeywordTotalOptIns) obj;
        ...
        if (this.totalOptIns != other.totalOptIns && (this.totalOptIns == null || !this.totalOptIns.equals(other.totalOptIns))) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        hash = 53 * hash + (this.totalOptIns != null ? this.totalOptIns.hashCode() : 0);
