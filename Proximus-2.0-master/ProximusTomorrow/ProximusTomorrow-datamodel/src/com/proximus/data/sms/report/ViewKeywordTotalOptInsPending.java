 ...
 */
@Entity
@Table(name = "view_keyword_total_opt_ins_pending")
public class ViewKeywordTotalOptInsPending implements Serializable {
    ...
    @Column(name = "total_opt_ins_pending")
    ...
    public boolean equals(Object obj) {
        ...
        final ViewKeywordTotalOptInsPending other = (ViewKeywordTotalOptInsPending) obj;
        ...
        if (this.totalOptInsPending != other.totalOptInsPending && (this.totalOptInsPending == null || !this.totalOptInsPending.equals(other.totalOptInsPending))) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        hash = 53 * hash + (this.totalOptInsPending != null ? this.totalOptInsPending.hashCode() : 0);
