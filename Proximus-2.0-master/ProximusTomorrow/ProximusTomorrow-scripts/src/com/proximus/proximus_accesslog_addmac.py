...
class HttpLogMod:
    ...
    def __init__(self,wifi_file="noactive.txt",log_dir='/home/proximus/logs/working', lease_file='/var/lib/misc/dnsmasq.leases'):
        self.log_dir = log_dir
        self.lease_file = lease_file
        if wifi_file == "noactive.txt":
		...
		today_format = now_date.strftime("%Y-%m-%d.%H-%M-%S")
		    ...
		    macAddr = "UNKNOWN"
		self.wifi_file = "wifi_"+macAddr+"_noActive_"+today_format+".txt"
        else:
