...
if __name__ == "__main__":
    if ( len(sys.argv) != 4 ):
        sys.stderr.write("Usage: %s <infile> <old_locale> <new_locale>\n" % sys.argv[0])
        raise SystemExit
    ...
    old_language = sys.argv[2]
    new_language = sys.argv[3]
    ...
    for line in inf.readlines():
        translated_value = getTranslatedString(original_language, new_language, token, line)
